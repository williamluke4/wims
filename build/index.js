...
const arg_1 = __importDefault(__webpack_require__(601));
/**
 * format
 */
...
const Version_1 = __webpack_require__(3);
const util_1 = __webpack_require__(669);
const Help_1 = __webpack_require__(466);
const utils_1 = __webpack_require__(132);
const Run_1 = __webpack_require__(855);
/**
 * CLI command
 */
class CLI {
    ...
    parse(argv) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (args._.length === 0 || args._.length === 1) {
                return Run_1.Run.new().parse(args._, args['--depth']);
            }
            ...
            // unknown command
            return Help_1.unknownCommand(CLI.help, args._[0]);
        });
    }
    // help function
    help(error) {
...
CLI.help = util_1.format(`
    ${chalk_1.default.bold.green('ಠ_ಠ')} Where Is My Space 

    ${chalk_1.default.bold('Usage')}

      ${chalk_1.default.dim(`$`)} wims [path]
    ...
    ${chalk_1.default.bold('Examples')}
      ...
      ${chalk_1.default.dim(`$`)} wims 
      ${chalk_1.default.dim(`$`)} wims /dev
      ${chalk_1.default.dim(`$`)} wims -d 2 /dev
 ...
 * Dependencies
 */
const CLI_1 = __webpack_require__(302);
const Version_1 = __webpack_require__(3);
const chalk_1 = __importDefault(__webpack_require__(946));
const Help_1 = __webpack_require__(466);
const utils_1 = __webpack_require__(132);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cli = CLI_1.CLI.new({
            version: Version_1.Version.new(),
        });
        // parse the arguments
        const result = yield cli.parse(process.argv.slice(2));
        if (result instanceof Help_1.HelpError) {
            console.error(result.message);
            return 1;
        }
        else if (utils_1.isError(result)) {
...
if (require.main === require.cache[eval('__filename')]) {
    main()
        ...
        .catch(err => {
        console.error(chalk_1.default.redBright.bold('Error: ') + err.stack);
        process.exit(1);
    });
}
...
module.exports = {"name":"wims","version":"0.1.1","license":"MIT","author":"William Luke","main":"dist/index.js","module":"dist/wims.esm.js","typings":"dist/index.d.ts","files":["dist"],"bin":{"wims":"build/index.js"},"scripts":{"start":"tsdx watch","test":"tsdx test","lint":"tsdx lint","tsc":"tsc -d","ncc":"ncc build dist/bin.js -o build","build":"yarn tsc && yarn ncc"},"peerDependencies":{},"husky":{"hooks":{"pre-commit":"tsdx lint"}},"prettier":{"printWidth":80,"semi":true,"singleQuote":true,"trailingComma":"es5"},"devDependencies":{"@types/jest":"^24.0.22","husky":"^3.0.9","tsdx":"^0.11.0","tslib":"^1.10.0","typescript":"^3.7.2"},"dependencies":{"@zeit/ncc":"^0.20.5","arg":"^4.1.1","chalk":"^2.4.2","execa":"^3.2.0","strip-indent":"^3.0.0"}};
...
class Run {
    ...
    run(base_path = '.', depth) {
        return __awaiter(this, void 0, void 0, function* () {
            const subprocess = yield execa_1.default('du', [base_path, `--max-depth=${depth}`]);
            ...
            output.locations.forEach((loc, idx) => {
                ...
                let str = '';
                const relative_path = path_1.default.relative(base_path, loc.path);
...
exports.Run = Run;
const bar_base = (str, color_idx = 0) => { return chalk_1.default.white[colors[color_idx]].bold(str); };
function parseStdOut(root_path, stdout) {
    let output = {
        total_size: 0,
        locations: []
    };
